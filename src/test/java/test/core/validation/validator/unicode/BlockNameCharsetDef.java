package test.core.validation.validator.unicode;

import nablarch.core.validation.validator.unicode.CharsetDefSupport;
...
/**
 * {@link UnicodeBlock}の名称による許容文字集合定義クラス。<br/>
 * 許容したいコードポイントの範囲が{@link UnicodeBlock}に定数定義されている場合、
 ...
 * <pre>
 * {@literal
 * <component name="kana" class="test.core.validation.validator.unicode.BlockNameCharsetDef">
